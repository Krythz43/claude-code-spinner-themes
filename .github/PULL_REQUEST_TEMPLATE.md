...
## If you are adding or changing a theme

- [ ] I edited `verbs.json` (the source of truth) and ran `node scripts/build.mjs`, so the README verb
      list is in sync
- [ ] `node scripts/validate.mjs <THEME-FOLDER>` passes with no errors
